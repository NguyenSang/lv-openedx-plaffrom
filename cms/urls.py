...
urlpatterns = patterns(
    '',
    # url(r'^lacviet/document/', 'lacviet.document.assets_lv.assets_document'),
...
urlpatterns += patterns(
    ...
    # url(r'^document/{}/{}?$'.format(settings.COURSE_KEY_PATTERN, settings.ASSET_KEY_PATTERN), 'assets_document'),
